<?php
/**
* Class ReportingBoEdit into Bo Controller
* @author SillySmart
* @copyright SillySmart
* @package Mvc.Controllers.Bo
* @see Mvc.Controllers.Bo.ControllerProtected
* @see Mvc.Controllers.SiteProtected
* @see Sls.Controllers.Core.SLS_GenericControllerva
* @since 1.0
*
*/
class SLS_BoReportingBoEdit extends SLS_BoControllerProtected
{
	...
	public function filterFields($e)
	{
		return $e->Field;
	}
