		...
		<form method="post" action="">
			...
			<table>
				...
				<tr>
					...
					<td><input type="text" name="login" id="login" value="{//View/login}" /></td>
				</tr>
				<tr>
				...
				<tr>
					<td>Privilege</td>
					<td>
						<xsl:if test="count(//View/bo_groups/bo_group[count(action) &gt; 0]) = 0">
							<span style="color:red;">No action from the back-office has been generated yet.</span>
							<a href="{//View/url_generate_bo}" title="Generate Bo">Generate Back-Office's actions now</a>
						</xsl:if>
