<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:php="http://php.net/xsl" xmlns="http://www.w3.org/1999/xhtml">
	<xsl:template name="AddComponentController">
	
		<h1>Manage your Controllers &amp; Actions</h1>
		<h2>Add a new Component Controller</h2>
		<form action="" method="post" enctype="multipart/form-data">
			...
			<fieldset>
				...
				<table>
					<tr>
						<td>Component Controller Name :</td>
						<td>
			...
			<table>
				<tr>
					<td colspan="2"><input type="submit" value="Add a new Component Controller" /><input type="hidden" name="reload" value="true" /></td>
				</tr>
			</table>
		</form>
