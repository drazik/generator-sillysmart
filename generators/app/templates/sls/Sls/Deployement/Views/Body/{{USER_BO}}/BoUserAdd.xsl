<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:php="http://php.net/xsl" xmlns="http://www.w3.org/1999/xhtml">
	<xsl:template name="BoUserAdd">

		<div id="sls-bo-fixed-header">
			<div class="sls-bo-fixed-header-content"></div>
		</div>
		<div class="fixed-in-header">
			<h1><span class="sls-bo-color-text">|||sls:lang:SLS_BO_USER_ADD_TITLE|||</span>&#160;|||sls:lang:SLS_BO_USER_ADD_SUBTITLE|||</h1>
		</div>
			...
			<form action="" method="post" sls-validation="true" sls-lang="{//Statics/Sls/Session/params/param[name='current_lang']/value}">
				...
				<div class="sls-bo-form-page-section form-type-regulars" sls-db="{//View/page/model/db}" sls-model="{//View/page/model/table}">
					...
					<div class="sls-bo-form-page-section-title-bar" id="sls-bo-section-basic">
						<h3>|||sls:lang:SLS_BO_USER_SECTION_INFOS|||</h3>
					</div>
					<div class="sls-bo-form-page-section-wrapper">
						<div class="sls-bo-form-page-section-content">
							...
							<div class="sls-form-page-field">
								<div class="sls-form-page-field-label">
									<label for="user-firstname">|||sls:lang:SLS_BO_USER_FIRST_NAME|||<sup class="required">*</sup></label>
								</div>
								<div class="sls-form-page-field-input">
							...
							<div class="sls-form-page-field">
								<div class="sls-form-page-field-label">
									<label for="user-password">|||sls:lang:SLS_BO_USER_PASSWORD|||<sup class="required">*</sup></label>
								</div>
								<div class="sls-form-page-field-input">
									<input type="password" name="user[password]" id="user-password" value="{//View/user/password}" placeholder="|||sls:lang:SLS_BO_GENERIC_CHOOSE_PASSWORD|||" sls-required="true" autocomplete="off" />
								</div>
							</div>
							<div class="sls-form-page-field">
								<div class="sls-form-page-field-label">
							...
							<div class="sls-form-page-field">
								...
								<div class="sls-form-page-field-input">
									<div class="toggler-btn toggler-btn-radio horizontal disabled">
							...
							<div class="sls-form-page-field">
								...
								<div class="sls-form-page-field-input sls-input-file sls-input-type-extended-img">
									...
									<div class="sls-input-file-drop-zone" onclick="var rendering = this.getParent('.sls-input-file').getElement('.sls-drop-zone-rendering'); if (!Browser.ie8 &amp;&amp; ((rendering &amp;&amp; !this.getParent('.sls-form-page-field-error')) || !rendering))$('user-photo').click();">
										<input type="file" name="user[photo]" id="user-photo" sls-input-file-value="" sls-image-min-width="160" sls-image-ratio="1" sls-type="file" sls-type-extended="img" sls-file-uid="USER_UID" sls-required="false" onchange="if (this.retrieve('FileUpload')) FileUpload.prototype.submit.call(this.retrieve('FileUpload')); if (Browser.ie8)this.retrieve('FileUpload').uploaderContainerForm.submit();" />
				...
				<div class="sls-bo-form-page-bottom">
					<div class="submit-block">
						<div class="sls-bo-form-page-submit sls-bo-color">|||sls:lang:SLS_BO_USER_ADD_SUBMIT|||</div>
					</div>
				</div>
			</form>
