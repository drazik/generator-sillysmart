<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:php="http://php.net/xsl" xmlns="http://www.w3.org/1999/xhtml">
	<xsl:template name="ReportingBoEdit">
		<div id="reporting_add" class="reporting_form sls_select_relayer">
			<h1>Edit graph</h1>
			<div style="margin:5px 0 20px 0;">
				<a href="{//View/url_report}" title="Back to list"><img src="{concat($sls_url_img_core_icons,'txt16.png')}" title="Back to list" alt="Back to list" style="border:0" align="absmiddle" />&#160;Back to list</a> | <a href="#" onclick="confirmDelete('{//View/url_delete}');return false;"><img src="{concat($sls_url_img_core_icons,'delete16.png')}" title="Delete" alt="Delete" style="border:0" align="absmiddle" />&#160;Delete this report</a>
			</div> 
							...
							<div class="value">
								<span class="btn_gen">
									...
									<span class="middle">
										...
										<input type="submit" name="submit_add" value="Edit"  class="btn_content" />
									</span>
